...
class TaskManager:
    def __init_(self):
        self.action_list = []
        self.occupied_locations:list[Position] = []
    ...
    def submit_action_unit(self, game_state: Game, unit: Unit, action: list[str]) -> bool:
        status = False
        ...
        if status == True:
            ...
            self.action_list.append(self.get_default_action(unit))
